...
Start the modules /FvwmPager/ and /FvwmEvent/, on startups and restarts, after FVWM has read its config. Also start [[https://github.com/brndnmtthws/conky][Conky]] to display some system information:
#+begin_src conf-space
